...
effective length is kept constant here. It reads the initial parameters from the
...
const double LEFF = 0.7; double R0 = 0.2; double ZMIN = -1.; double ZMAX = -ZMIN;
...
code is kept in. */
	...
	write_final_parameters("final_parameters_global_leff_const.txt", FitParameters);
